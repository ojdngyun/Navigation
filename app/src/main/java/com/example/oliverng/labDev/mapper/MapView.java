...
package com.example.oliverng.labDev.mapper;
...
public class MapView extends View
{
    ...
    public void changeScale(PointF point, float[] dimension){
        scale = point;
        fieldWidth = dimension[0];
        fieldHeight = dimension[1];
        invalidate();
    }
    ...
    public float[] getDimension(){
        return new float[] {fieldWidth, fieldHeight};
    }
